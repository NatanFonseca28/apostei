            ...
            try:
                ...
                for partida in todas_partidas:
                    ...
                    try:
                        ...
                        time_fora = time_fora_elem.text.strip()
                    except Exception as e:
                    ...
                    probabilidade_gol = classificar_probabilidade_gol(
                        class_marcados_casa, class_sofridos_fora, class_marcados_fora, class_sofridos_casa
                    )
                    
                    melhor_chance = determinar_melhor_chance(
                        class_marcados_casa, class_sofridos_fora, class_marcados_fora, class_sofridos_casa
                    )
